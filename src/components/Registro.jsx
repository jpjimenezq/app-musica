      ...
      <div className="relative z-10 flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="bg-white bg-opacity-90 backdrop-blur-md p-8 rounded-xl shadow-2xl w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmarPassword" className="block text-sm font-medium text-gray-700">Confirmar Contraseña</label>
              <input
                type="password"
          ...
          <p className="mt-4 text-center text-sm text-gray-600">
            ¿Ya tienes una cuenta? <Link href="/login" className="font-medium text-sky-600 hover:text-sky-500">Inicia sesión</Link>
          </p>
        </div>
      </div>
    </div>
